    ...
    <div className="flex h-screen bg-[#14161B] text-white font-sans overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-275 mx-auto px-6 py-8 pt-20 md:p-10 lg:p-12">
          {/* Header & Stats & Tasks */}
          <DashboardHeader title="Pending Tasks" subtitle={<>You can do it! You have {tasks.filter((t) => !t.completed).length} pending tasks.</>} tasks={tasks} searchQuery={searchQuery} setSearchQuery={setSearchQuery} onOpenModal={openModal}>
